...
class TransUnitRepositoryTest extends BaseUnitTestCase
{
    ...
    public function testCount()
    {
        ...
        $this->assertEquals(1, $repository->countByLocales(['en', 'fr', 'de'], ['_search' => true, 'key' => 'hel', 'domain' => 'uper']));
        $this->assertEquals(2, $repository->countByLocales(['en', 'de'], ['_search' => true, 'key' => 'say', 'domain' => 'ssa']));
    }
